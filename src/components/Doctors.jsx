...
const Doctors = ({doctors ,appointments, setAppointments}) => {
  ...
  const [selectedDrnName, setSelectedDrnName] = useState("")

const handleClick = (drName) =>{
  setShow(true)
  setSelectedDrnName(drName)
}
  ...
  return (
    <Container className="p-2">
      ...
      <AddModal show={show} handleClose={() => setShow(false)} drName={selectedDrnName} appointments={appointments} setAppointments={setAppointments} />
    </Container>
  )
}
